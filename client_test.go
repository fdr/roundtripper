...
func TestRedirects(t *testing.T) {
	...
	c = &http.Client{CheckRedirect: func(_ *http.Request, via []*http.Request) error {
		lastVia = via
		return checkErr
	}}
...
func TestPostRedirects(t *testing.T) {
	...
	for _, tt := range tests {
		res, err := http.Post(ts.URL+tt.suffix, "text/plain", strings.NewReader("Some content"))
		if err != nil {
			t.Fatal(err)
		}
...
func TestClientWrites(t *testing.T) {
	...
	c := &http.Client{Transport: &Transport{Dial: dialer}}
...
func TestClientWithCorrectTLSServerName(t *testing.T) {
	...
	c := &http.Client{Transport: newTLSTransport(t, ts)}
...
func TestClientHeadContentLength(t *testing.T) {
	...
	for _, tt := range tests {
		req, _ := http.NewRequest("HEAD", ts.URL+tt.suffix, nil)
